...
def origin(name = 'national'):
    if name == 'europe':
        return wine_data[(wine_data['country'] == 'Spain') 
                         ...
                         | (wine_data['country'] == 'Macedonia')].iloc[0:10].transpose().to_dict()
    elif name == 'national':
        return wine_data[wine_data['country'] == 'Germany'].iloc[0:10].transpose().to_dict()
        ...
        return wine_data[(wine_data['country'] == 'Mexico') 
                         ...
                         | (wine_data['country'] == 'Armenia')].iloc[0:10].transpose().to_dict()
    else:
        return wine_data.iloc[0:10].transpose().to_dict()
